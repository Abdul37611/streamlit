...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cvrp.tsp",
        "sources": [
            "./cvrp/swap_heuristic.pyx"
        ]
    },
    "module_name": "cvrp.tsp"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cvrp__tsp
#define __PYX_HAVE_API__cvrp__tsp
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* "dimod/quadratic/cyqm/cyqm_float32.pxd":20
 * cimport numpy as np
 * 
 * ctypedef np.float32_t bias_type             # <<<<<<<<<<<<<<
 * ctypedef np.int32_t index_type
 * 
 */
typedef __pyx_t_5numpy_float32_t __pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float32_bias_type;

/* "dimod/quadratic/cyqm/cyqm_float32.pxd":21
 * 
 * ctypedef np.float32_t bias_type
 * ctypedef np.int32_t index_type             # <<<<<<<<<<<<<<
 * 
 ...
 */
typedef __pyx_t_5numpy_int32_t __pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float32_index_type;

/* "dimod/quadratic/cyqm/cyqm_float64.pxd":20
 * cimport numpy as np
 * 
 * ctypedef np.float64_t bias_type             # <<<<<<<<<<<<<<
 * ctypedef np.int32_t index_type
 * 
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float64_bias_type;

/* "dimod/quadratic/cyqm/cyqm_float64.pxd":21
 * 
 * ctypedef np.float64_t bias_type
 * ctypedef np.int32_t index_type             # <<<<<<<<<<<<<<
 * 
 * include "cyqm_template.pxd.pxi"
 */
typedef __pyx_t_5numpy_int32_t __pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float64_index_type;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template;
struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32;
...
/* "../../.local/lib/python3.6/site-packages/dimod/binary/cybqm/cybqm_template.pxd.pxi":37
...
/* "../../.local/lib/python3.6/site-packages/dimod/binary/cybqm/cybqm_template.pxd.pxi":36
...
struct __pyx_fuse_0__pyx_opt_args_5dimod_9quadratic_4cyqm_12cyqm_float32_13cyQM_template__energies;
struct __pyx_fuse_1__pyx_opt_args_5dimod_9quadratic_4cyqm_12cyqm_float32_13cyQM_template__energies;

/* "../../.local/lib/python3.6/site-packages/dimod/quadratic/cyqm/cyqm_template.pxd.pxi":33
 * 
 *     cdef void _add_linear(self, Py_ssize_t, bias_type)
 *     cdef cython.floating[::1] _energies(self, object samples_like, cython.floating signal=*)             # <<<<<<<<<<<<<<
 *     cdef void _set_linear(self, Py_ssize_t, bias_type)
...
struct __pyx_fuse_0__pyx_opt_args_5dimod_9quadratic_4cyqm_12cyqm_float64_13cyQM_template__energies;
struct __pyx_fuse_1__pyx_opt_args_5dimod_9quadratic_4cyqm_12cyqm_float64_13cyQM_template__energies;
struct __pyx_fuse_0__pyx_opt_args_5dimod_9quadratic_4cyqm_12cyqm_float64_13cyQM_template__energies {
  int __pyx_n;
  float signal;
};
...
struct __pyx_opt_args_4cvrp_3tsp_solve_tsp;

/* "cvrp/swap_heuristic.pyx":19
 * 
 * 
...
/* "../../.local/lib/python3.6/site-packages/dimod/binary/cybqm/cybqm_template.pxd.pxi":23
 * 
 * 
...
/* "../../.local/lib/python3.6/site-packages/dimod/quadratic/cyqm/cyqm_template.pxd.pxi":25
 * 
 * 
 ...
 */
struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template {
  struct __pyx_obj_5dimod_9quadratic_4cyqm_9cyqm_base_cyQMBase __pyx_base;
  struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *__pyx_vtab;
  dimod::QuadraticModel<__pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float32_bias_type,__pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float32_index_type>  cppqm;
  PyObject *dtype;
  PyObject *index_dtype;
  struct __pyx_obj_5dimod_11cyvariables_cyVariables *variables;
};
...
/* "dimod/quadratic/cyqm/cyqm_float32.pxd":27
 ...
 */
struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32 {
  struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template __pyx_base;
};
...
struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template {
  struct __pyx_obj_5dimod_9quadratic_4cyqm_9cyqm_base_cyQMBase __pyx_base;
  struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template *__pyx_vtab;
  dimod::QuadraticModel<__pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float64_bias_type,__pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float64_index_type>  cppqm;
  PyObject *dtype;
  PyObject *index_dtype;
  struct __pyx_obj_5dimod_11cyvariables_cyVariables *variables;
};
...
/* "dimod/quadratic/cyqm/cyqm_float64.pxd":27
...
struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template {
  void (*_add_linear)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *, Py_ssize_t, __pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float32_bias_type);
  void (*_set_linear)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *, Py_ssize_t, __pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float32_bias_type);
  enum dimod::Vartype (*cppvartype)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *, PyObject *);
  dimod::QuadraticModel<__pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float32_bias_type,__pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float32_index_type>  const *(*data)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *);
  int (*is_linear)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *, int __pyx_skip_dispatch);
  void (*scale)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *, __pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float32_bias_type, int __pyx_skip_dispatch);
  Py_ssize_t (*num_interactions)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *, int __pyx_skip_dispatch);
  Py_ssize_t (*num_variables)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *, int __pyx_skip_dispatch);
  __Pyx_memviewslice (*__pyx_fuse_0_energies)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *, PyObject *, struct __pyx_fuse_0__pyx_opt_args_5dimod_9quadratic_4cyqm_12cyqm_float32_13cyQM_template__energies *__pyx_optional_args);
  __Pyx_memviewslice (*__pyx_fuse_1_energies)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *, PyObject *, struct __pyx_fuse_1__pyx_opt_args_5dimod_9quadratic_4cyqm_12cyqm_float32_13cyQM_template__energies *__pyx_optional_args);
};
static struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template *__pyx_vtabptr_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template;
...
struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32 {
  struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template __pyx_base;
};
static struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32 *__pyx_vtabptr_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32;
...
struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template {
  void (*_add_linear)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template *, Py_ssize_t, __pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float64_bias_type);
  void (*_set_linear)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template *, Py_ssize_t, __pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float64_bias_type);
  enum dimod::Vartype (*cppvartype)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template *, PyObject *);
  dimod::QuadraticModel<__pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float64_bias_type,__pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float64_index_type>  const *(*data)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template *);
  int (*is_linear)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template *, int __pyx_skip_dispatch);
  void (*scale)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template *, __pyx_t_5dimod_9quadratic_4cyqm_12cyqm_float64_bias_type, int __pyx_skip_dispatch);
  Py_ssize_t (*num_interactions)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template *, int __pyx_skip_dispatch);
  Py_ssize_t (*num_variables)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template *, int __pyx_skip_dispatch);
  __Pyx_memviewslice (*__pyx_fuse_0_energies)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template *, PyObject *, struct __pyx_fuse_0__pyx_opt_args_5dimod_9quadratic_4cyqm_12cyqm_float64_13cyQM_template__energies *__pyx_optional_args);
  __Pyx_memviewslice (*__pyx_fuse_1_energies)(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template *, PyObject *, struct __pyx_fuse_1__pyx_opt_args_5dimod_9quadratic_4cyqm_12cyqm_float64_13cyQM_template__energies *__pyx_optional_args);
};
...
/* Module declarations from 'dimod.binary' */
...
/* Module declarations from 'dimod.quadratic.cyqm.cyqm_float32' */
static PyTypeObject *__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template = 0;
static PyTypeObject *__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32 = 0;

/* Module declarations from 'dimod.quadratic.cyqm.cyqm_float64' */
static PyTypeObject *__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template = 0;
static PyTypeObject *__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_float64 = 0;

/* Module declarations from 'dimod.quadratic.cyqm' */

/* Module declarations from 'dimod.quadratic' */

/* Module declarations from 'dimod' */

/* Module declarations from 'libcpp' */

/* Module declarations from 'cvrp.tsp' */
...
static PyObject *__pyx_f_4cvrp_3tsp_solve_tsp(std::vector<std::vector<double> > , PyObject *, double, double, double, int __pyx_skip_dispatch, struct __pyx_opt_args_4cvrp_3tsp_solve_tsp *__pyx_optional_args); /*proto*/
...
static PyObject *__pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______double(std::pair<std::vector<int> ,double>  const &); /*proto*/
static PyObject *__pyx_convert_vector_to_py_std_3a__3a_pair_3c_std_3a__3a_vector_3c_int_3e____2c_double_3e___(const std::vector<std::pair<std::vector<int> ,double> >  &); /*proto*/
...
#define __Pyx_MODULE_NAME "cvrp.tsp"
extern int __pyx_module_is_main_cvrp__tsp;
int __pyx_module_is_main_cvrp__tsp = 0;

/* Implementation of 'cvrp.tsp' */
...
static PyObject *__pyx_pf_4cvrp_3tsp_solve_tsp(CYTHON_UNUSED PyObject *__pyx_self, std::vector<std::vector<double> >  __pyx_v_distances, PyObject *__pyx_v_states, double __pyx_v_beta, double __pyx_v_max_beta, double __pyx_v_scale, int __pyx_v_n); /* proto */
...
static PyObject *__pyx_pw_4cvrp_3tsp_1solve_tsp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_4cvrp_3tsp_solve_tsp(std::vector<std::vector<double> >  __pyx_v_distances, PyObject *__pyx_v_states, double __pyx_v_beta, double __pyx_v_max_beta, double __pyx_v_scale, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_4cvrp_3tsp_solve_tsp *__pyx_optional_args) {
  int __pyx_v_n = ((int)12);
  std::vector<std::vector<int> >  __pyx_v_states_c;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("solve_tsp", 0);
 ...
 *         m = len(distances)
 */
  __pyx_t_1 = (__pyx_v_states == Py_None);
  __pyx_t_2 = (__pyx_t_1 != 0);
  if (__pyx_t_2) {

    /* "cvrp/swap_heuristic.pyx":24
 *     cdef vector[vector[int]] states_c
 *     if states is None:
 *         import numpy as np             # <<<<<<<<<<<<<<
 *         m = len(distances)
 *         r = list(range(m))
 */
    __pyx_t_3 = __Pyx_Import(__pyx_n_s_numpy, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 24, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_v_np = __pyx_t_3;
    __pyx_t_3 = 0;

    /* "cvrp/swap_heuristic.pyx":25
 *     if states is None:
 *         import numpy as np
 *         m = len(distances)             # <<<<<<<<<<<<<<
 *         r = list(range(m))
 *         states = []
 */
    __pyx_t_3 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_double_3e___(__pyx_v_distances); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 25, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyObject_Length(__pyx_t_3); if (unlikely(__pyx_t_4 == ((Py_ssize_t)-1))) __PYX_ERR(0, 25, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_v_m = __pyx_t_4;

    /* "cvrp/swap_heuristic.pyx":26
 *         import numpy as np
 *         m = len(distances)
 *         r = list(range(m))             # <<<<<<<<<<<<<<
 *         states = []
 *         for _ in range(n):
 */
    __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_m); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_builtin_range, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PySequence_List(__pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_v_r = ((PyObject*)__pyx_t_3);
    __pyx_t_3 = 0;

    /* "cvrp/swap_heuristic.pyx":27
 *         m = len(distances)
 *         r = list(range(m))
 *         states = []             # <<<<<<<<<<<<<<
 *         for _ in range(n):
 ...
 *         states_c = states
 */
      __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_random); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 29, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_shuffle); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 29, __pyx_L1_error)
      ...
      __pyx_t_3 = (__pyx_t_5) ? __Pyx_PyObject_Call2Args(__pyx_t_9, __pyx_t_5, __pyx_v_r) : __Pyx_PyObject_CallOneArg(__pyx_t_9, __pyx_v_r);
 ...
 *     else:
 */
      __pyx_t_10 = __Pyx_PyObject_Append(__pyx_v_states, __pyx_v_r); if (unlikely(__pyx_t_10 == ((int)-1))) __PYX_ERR(0, 30, __pyx_L1_error)
    }

    /* "cvrp/swap_heuristic.pyx":31
 *             np.random.shuffle(r)
 *             states.append(r)
 *         states_c = states             # <<<<<<<<<<<<<<
 *     else:
 *         states_c = states
 */
    __pyx_t_11 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_int_3e___(__pyx_v_states); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 31, __pyx_L1_error)
    __pyx_v_states_c = __pyx_t_11;
 ...
 */
  /*else*/ {
    __pyx_t_11 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_int_3e___(__pyx_v_states); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L1_error)
    __pyx_v_states_c = __pyx_t_11;
  }
  __pyx_L3:;

  /* "cvrp/swap_heuristic.pyx":34
 *     else:
 *         states_c = states
 *     return solve(distances, states_c, beta, max_beta, scale, n)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = __pyx_convert_vector_to_py_std_3a__3a_pair_3c_std_3a__3a_vector_3c_int_3e____2c_double_3e___(solve(__pyx_v_distances, __pyx_v_states_c, __pyx_v_beta, __pyx_v_max_beta, __pyx_v_scale, __pyx_v_n)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("cvrp.tsp.solve_tsp", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_4cvrp_3tsp_1solve_tsp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_4cvrp_3tsp_1solve_tsp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  std::vector<std::vector<double> >  __pyx_v_distances;
  PyObject *__pyx_v_states = 0;
  double __pyx_v_beta;
  double __pyx_v_max_beta;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("solve_tsp (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_distances,&__pyx_n_s_states,&__pyx_n_s_beta,&__pyx_n_s_max_beta,&__pyx_n_s_scale,&__pyx_n_s_n,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_states)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("solve_tsp", 0, 5, 6, 1); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_beta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("solve_tsp", 0, 5, 6, 2); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_max_beta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("solve_tsp", 0, 5, 6, 3); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_scale)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("solve_tsp", 0, 5, 6, 4); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "solve_tsp") < 0)) __PYX_ERR(0, 19, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_distances = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_double_3e___(values[0]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    ...
    __pyx_v_max_beta = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_max_beta == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_scale = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_scale == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    if (values[5]) {
      __pyx_v_n = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_n == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    } else {
      __pyx_v_n = ((int)12);
    }
  }
  ...
  __Pyx_RaiseArgtupleInvalid("solve_tsp", 0, 5, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cvrp.tsp.solve_tsp", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4cvrp_3tsp_solve_tsp(__pyx_self, __pyx_v_distances, __pyx_v_states, __pyx_v_beta, __pyx_v_max_beta, __pyx_v_scale, __pyx_v_n);
...
static PyObject *__pyx_pf_4cvrp_3tsp_solve_tsp(CYTHON_UNUSED PyObject *__pyx_self, std::vector<std::vector<double> >  __pyx_v_distances, PyObject *__pyx_v_states, double __pyx_v_beta, double __pyx_v_max_beta, double __pyx_v_scale, int __pyx_v_n) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_4cvrp_3tsp_solve_tsp __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("solve_tsp", 0);
  ...
  __pyx_t_1 = __pyx_f_4cvrp_3tsp_solve_tsp(__pyx_v_distances, __pyx_v_states, __pyx_v_beta, __pyx_v_max_beta, __pyx_v_scale, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
...
/* "pair.to_py":158
 * 
 * @cname("__pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______double")
 * cdef object __pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______double(const pair[X,Y]& p):             # <<<<<<<<<<<<<<
 *     return p.first, p.second
 * 
 */

static PyObject *__pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______double(std::pair<std::vector<int> ,double>  const &__pyx_v_p) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______double", 0);
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_convert_vector_to_py_int(__pyx_v_p.first); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 159, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_p.second); if (unlikely(!__pyx_t_2)) __PYX_ERR(2, 159, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_AddTraceback("pair.to_py.__pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______double", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* "vector.to_py":60
 * 
 * @cname("__pyx_convert_vector_to_py_std_3a__3a_pair_3c_std_3a__3a_vector_3c_int_3e____2c_double_3e___")
 * cdef object __pyx_convert_vector_to_py_std_3a__3a_pair_3c_std_3a__3a_vector_3c_int_3e____2c_double_3e___(vector[X]& v):             # <<<<<<<<<<<<<<
 *     return [v[i] for i in range(v.size())]
 * 
 */

static PyObject *__pyx_convert_vector_to_py_std_3a__3a_pair_3c_std_3a__3a_vector_3c_int_3e____2c_double_3e___(const std::vector<std::pair<std::vector<int> ,double> >  &__pyx_v_v) {
  size_t __pyx_v_i;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_convert_vector_to_py_std_3a__3a_pair_3c_std_3a__3a_vector_3c_int_3e____2c_double_3e___", 0);
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;
    __pyx_t_5 = __pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______double((__pyx_v_v[__pyx_v_i])); if (unlikely(!__pyx_t_5)) __PYX_ERR(2, 61, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    if (unlikely(__Pyx_ListComp_Append(__pyx_t_1, (PyObject*)__pyx_t_5))) __PYX_ERR(2, 61, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  }
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_AddTraceback("vector.to_py.__pyx_convert_vector_to_py_std_3a__3a_pair_3c_std_3a__3a_vector_3c_int_3e____2c_double_3e___", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cvrp.tsp._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"solve_tsp", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4cvrp_3tsp_1solve_tsp, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_tsp(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_tsp},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("dimod.quadratic.cyqm.cyqm_base"); if (unlikely(!__pyx_t_1)) __PYX_ERR(9, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_5dimod_9quadratic_4cyqm_9cyqm_base_cyQMBase = __Pyx_ImportType(__pyx_t_1, "dimod.quadratic.cyqm.cyqm_base", "cyQMBase", sizeof(struct __pyx_obj_5dimod_9quadratic_4cyqm_9cyqm_base_cyQMBase), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5dimod_9quadratic_4cyqm_9cyqm_base_cyQMBase) __PYX_ERR(9, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("dimod.quadratic.cyqm.cyqm_float32"); if (unlikely(!__pyx_t_1)) __PYX_ERR(10, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template = __Pyx_ImportType(__pyx_t_1, "dimod.quadratic.cyqm.cyqm_float32", "cyQM_template", sizeof(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template) __PYX_ERR(10, 25, __pyx_L1_error)
  __pyx_vtabptr_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template = (struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template*)__Pyx_GetVtable(__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template->tp_dict); if (unlikely(!__pyx_vtabptr_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_template)) __PYX_ERR(10, 25, __pyx_L1_error)
  __pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32 = __Pyx_ImportType(__pyx_t_1, "dimod.quadratic.cyqm.cyqm_float32", "cyQM_float32", sizeof(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32) __PYX_ERR(11, 27, __pyx_L1_error)
  __pyx_vtabptr_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32 = (struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32*)__Pyx_GetVtable(__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32->tp_dict); if (unlikely(!__pyx_vtabptr_5dimod_9quadratic_4cyqm_12cyqm_float32_cyQM_float32)) __PYX_ERR(11, 27, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("dimod.quadratic.cyqm.cyqm_float64"); if (unlikely(!__pyx_t_1)) __PYX_ERR(10, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template = __Pyx_ImportType(__pyx_t_1, "dimod.quadratic.cyqm.cyqm_float64", "cyQM_template", sizeof(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template) __PYX_ERR(10, 25, __pyx_L1_error)
  __pyx_vtabptr_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template = (struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template*)__Pyx_GetVtable(__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template->tp_dict); if (unlikely(!__pyx_vtabptr_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_template)) __PYX_ERR(10, 25, __pyx_L1_error)
  __pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_float64 = __Pyx_ImportType(__pyx_t_1, "dimod.quadratic.cyqm.cyqm_float64", "cyQM_float64", sizeof(struct __pyx_obj_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_float64), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_float64) __PYX_ERR(12, 27, __pyx_L1_error)
  __pyx_vtabptr_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_float64 = (struct __pyx_vtabstruct_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_float64*)__Pyx_GetVtable(__pyx_ptype_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_float64->tp_dict); if (unlikely(!__pyx_vtabptr_5dimod_9quadratic_4cyqm_12cyqm_float64_cyQM_float64)) __PYX_ERR(12, 27, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC inittsp(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC inittsp(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_tsp(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_tsp(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_tsp(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'tsp' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_tsp(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("tsp", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cvrp__tsp) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cvrp.tsp")) {
      if (unlikely(PyDict_SetItemString(modules, "cvrp.tsp", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cvrp.tsp", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cvrp.tsp");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
